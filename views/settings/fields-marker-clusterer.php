<?php if ( $field['label_for'] == BasicGoogleMapsPlacemarks::PREFIX . 'marker-clustering' ) : ?>
	...
	<input id="<?php esc_attr_e( BasicGoogleMapsPlacemarks::PREFIX ); ?>marker-clustering" name="<?php esc_attr_e( BasicGoogleMapsPlacemarks::PREFIX ); ?>marker-clustering" type="checkbox" <?php echo checked( $markerClustering, 'on', false ); ?> />
...
<?php elseif ( $field['label_for'] == BasicGoogleMapsPlacemarks::PREFIX . 'cluster-max-zoom' ) : ?>
	...
	<input id="<?php esc_attr_e( BasicGoogleMapsPlacemarks::PREFIX ); ?>cluster-max-zoom" name="<?php esc_attr_e( BasicGoogleMapsPlacemarks::PREFIX ); ?>cluster-max-zoom" type="text" value="<?php esc_attr_e( $clusterMaxZoom ); ?>" class="small-text" />
...
<?php elseif ( $field['label_for'] == BasicGoogleMapsPlacemarks::PREFIX . 'cluster-grid-size' ) : ?>
	...
	<input id="<?php esc_attr_e( BasicGoogleMapsPlacemarks::PREFIX ); ?>cluster-grid-size" name="<?php esc_attr_e( BasicGoogleMapsPlacemarks::PREFIX ); ?>cluster-grid-size" type="text" value="<?php esc_attr_e( $clusterGridSize ); ?>" class="small-text" />
	<p class="description">
